 ...
 * Function: RecyclerVIew 的分割线
 */

public class RecycleLine extends RecyclerView.ItemDecoration {
    /*
    ...
    public RecycleLine(Context context, int orientation) {
        /* 这个构造方法用于处理线性布局传入的情况，我们要对myDivider对象进行初始化
        * （绘制的颜色和宽度等等）
        * R.drawable.my_list_divider 是我们自定义的一个drawable资源文件,我们通过
        * myContext来获取它
        */
        myDivider = context.getResources().getDrawable(R.drawable.line);
    ...
    public RecycleLine(Context context, int orientation, int rawOrColumnSum) {
